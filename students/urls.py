...
urlpatterns = [
    ...
    url(r'^courses/(?P<pk>\d+)/$', views.StudentCourseDetailView.as_view(), name='student_course_list'),
    url(r'^courses/(?P<pk>\d+)/(?P<module_id>\d+)/$', views.StudentCourseDetailView.as_view(), name='student_course_detail_module'),
